...
import { SearchResponse } from "../services/studSearchServices";
...
const SearchResult: React.FC<SearchResultProps> = (props) => {
  ...
  return (
    <>
      ...
      >
        <div
          className="nav nav-tabs flex-row align-items-baseline"
          style={{ paddingLeft: "5%", width: "118%", paddingBottom: "2%" }}
        >
          <div className="about-thumb bg-white shadow-lg">
            ...
            {!props.searchResult.items && (
              <h2
                style={{ textAlign: "center", color: "red", marginTop: "15px" }}
              >
                {" "}
