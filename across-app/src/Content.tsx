                        ...
                        <div className="col-lg-10 col-12 text-left mb-4">
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={naturalScienceImage} className="img-fluid projects-image" alt="Natural Science" />
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={computerScienceImage} className="img-fluid projects-image" alt="Computer Science" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
                                                <h4 className="projects-title">Computer <br /> Science</h4>
                                            </div>
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={mathematicsImage} className="img-fluid projects-image" alt="Mathematics" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={economicsImage} className="img-fluid projects-image" alt="Economics" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={mechanicalEngineeringImage} className="img-fluid projects-image" alt="Mechanical Engineering" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={humanityImage} className="img-fluid projects-image" alt="Humanity" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={electricalEnginerringImage} className="img-fluid projects-image" alt="Electrical Enginerring" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
                            ...
                            <div className="col-lg-3 col-12">
                                <div className="projects-thumb projects-thumb-small">
                                    <a href="#">
                                        <img src={MusicAndArtImage} className="img-fluid projects-image" alt="Music And Art" />
                                        <div className="projects-info">
                                            <div className="projects-title-wrap">
