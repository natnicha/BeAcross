...
def test_put_auth_user_profile_sys_admin_success(mocker):
    ...
    response = client.put(
        ...
        headers={"Content-Type":"application/json", "Authorization": f"Bearer {sys_admin_jwt}"},
        json={
        "id": "65e98e36c94f65783c3bad4c",
        "email": "natnicha.rodtong@s2022.tu-chemnitz.de",
        "password": "ea9a244685d02eafb18b2a4cc045954c0fa638c7767ecb3624d752986a313883:9093f8d4c159496998ee0976e9aa5335",
        "first_name": "example",
        "last_name": "c",
        "registration_number": None,
        "course_of_study": None,
...
def test_put_admin_user_profile_sys_admin_success(mocker):
    load_env()
    init_setting()
    user = {
        "_id" : ObjectId("65e98e36c94f65783c3bad4c"),
...
def test_delete_auth_user_profile_uni_admin_success(mocker):
    load_env()
    init_setting()
    user = {
        "_id" : ObjectId("65e4d22ba21d308eca0c531d"),
...
def test_delete_admin_user_profile_sys_admin_success(mocker):
    load_env()
    init_setting()
    user = {
        "_id" : ObjectId("65e4d22ba21d308eca0c531d"),
