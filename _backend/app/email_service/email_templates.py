...
<html>
    <head>Hi <font color="#f75940">{user}!</font></head>
    <body font-family: 'Source Sans Pro'>
        <br>
        Welcome to <font color="#f75940">Across</font>. Thank you for registering with us. <br>
        ...
        Login email: <font color="#f75940">{email}</font><br>
        Your password is: <font color="#f75940">{password}</font><br>
        <br>
        <b>Ready to organize your new chapter of study life ?</b><br>
        <b><a href="http://localhost:3000/"><font color="#f75940">Across</font></a></b><br>
        <br>
